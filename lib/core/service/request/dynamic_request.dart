...
class DynamicRequest {
  ...
  ///web端 获取所有动态
  static Future<WebDynamicV1FeedAllModel> getWebDynamicV1FeedAll(params) async {
    String url = "/x/polymer/web-dynamic/v1/feed/all?${ParamsSign.paramsSerialization(params)}";
