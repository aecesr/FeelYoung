  ...
  dealMirror(state, value) {
    ...
    if (value) {
      trtcCloud.setLocalRenderParams(
          TRTCRenderParams(mirrorType: TRTCCloudDef.TRTC_VIDEO_MIRROR_TYPE_ENABLE));
    } else {
      trtcCloud.setLocalRenderParams(
              ...
              child: CupertinoPicker(
                ...
                onSelectedItemChanged: (position) {
                  ...
                  morePageState(() {
                    ...
                    minBitrate = double.parse(resolutionList[position]['minBitrate'].toString());
                    maxBitrate = double.parse(resolutionList[position]['maxBitrate'].toString());
                    currentBitrate =
                        double.parse(resolutionList[position]['curBitrate'].toString());
                  });
                },
                children: resolutionList.map((item) => Text(item['text'])).toList(),
              ),
            );
          });
        },
          ...
          return StatefulBuilder(builder: (context1, state) {
            return Container(
              ...
              child: CupertinoPicker(
                ...
                children: videoFpsList.map((item) => Text(item.toString())).toList(),
              ),
            );
          });
        },
            ...
            child: MaterialApp(
              ...
              home: DefaultTabController(
                ...
                child: Scaffold(
                  ...
                  backgroundColor: HYAppTheme.norBlue02Colors,
                  appBar: AppBar(
                      // backgroundColor: Color.fromRGBO(19, 41, 75, 1),
                      backgroundColor: HYAppTheme.norBlue02Colors,
                      bottom: TabBar(
                          ...
                          Row(
                            children: <Widget>[
                              ...
                              Container(
                                  ...
                                  child: Switch(
                                      value: enabledMirror,
                                      onChanged: (value) => dealMirror(state, value)))
                            ],
                          ),
                        ]),
                      ),
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                Slider(
                                  ...
                                  onChanged: (double value) {
                                    trtcCloud.setAudioCaptureVolume(value.round());
                                    state(() {
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                Slider(
                                  ...
                                  onChanged: (double value) {
                                    trtcCloud.setAudioPlayoutVolume(value.round());
                                    state(() {
