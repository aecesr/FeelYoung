...
import 'package:FeelYoung_getx/core/qq_util/qq_util.dart';
...
import 'feelyoung_video_player_logic.dart';

///视频播放界面，传入视频源（videoOriginalUrl），控制需要显示的组件即可
class FeelYoungVideoPlayerComponent extends StatefulWidget {
  @override
  State<FeelYoungVideoPlayerComponent> createState() =>
      _FeelYoungVideoPlayerComponentState();
}

class _FeelYoungVideoPlayerComponentState
    extends State<FeelYoungVideoPlayerComponent>  {
  final logic = Get.put(FeelYoungVideoPlayerLogic());
  final state = Get.find<FeelYoungVideoPlayerLogic>().state;


  @override
  Widget build(BuildContext context) {
    return GetBuilder<FeelYoungVideoPlayerLogic>(builder: (logic) {
      return Center(
  ...
  void dispose() {
    ...
    Get.delete<FeelYoungVideoPlayerComponent>();
    super.dispose();
  }
